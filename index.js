...
module.exports = async(client, url) => {
    ...
    if(!url || typeof url !== 'string' || !url.startsWith(`mongodb://`) || !url.startsWith("mongodb+srv")) throw new Error("INVALID_MONGO_URL: There is no Mongo URL provided or it is invalid.")
